...
export function Hero() {
  return(
    <div className="space-y-5">
      ...
      <Link href="/memories/new" className='inline-block rounded-full bg-green-500 px-5 py-5 font-alt text-sm uppercase leading-none text-black hover:bg-green-400'>Cadastrar lembrança</Link>
    </div>
  )
}